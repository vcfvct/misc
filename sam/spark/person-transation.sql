...
INSERT INTO transaction VALUES (10, 1, 100, 1, 2022, 'fairfax', 'va');
INSERT INTO transaction VALUES (11, 1, 101, 2, 2022, 'fairfax', 'va');
INSERT INTO transaction VALUES (12, 1, 102, 1, 2022, 'fairfax', 'va');
INSERT INTO transaction VALUES (13, 1, 203, 1, 2022, 'potomac', 'md');

INSERT INTO transaction VALUES (20, 2, 100, 1, 2022, 'fairfax', 'va');
INSERT INTO transaction VALUES (21, 2, 101, 1, 2022, 'fairfax', 'va');
INSERT INTO transaction VALUES (22, 2, 102, 2, 2022, 'fairfax', 'va');
INSERT INTO transaction VALUES (23, 2, 203, 1, 2022, 'potomac', 'md');

INSERT INTO transaction VALUES (30, 3, 100, 1, 2022, 'fairfax', 'va');
INSERT INTO transaction VALUES (31, 3, 101, 1, 2022, 'fairfax', 'va');
INSERT INTO transaction VALUES (32, 3, 102, 2, 2021, 'fairfax', 'va');
INSERT INTO transaction VALUES (33, 3, 203, 1, 2022, 'potomac', 'md');

INSERT INTO transaction VALUES (40, 4, 100, 1, 2022, 'fairfax', 'va');
INSERT INTO transaction VALUES (41, 4, 101, 1, 2022, 'fairfax', 'va');
INSERT INTO transaction VALUES (42, 4, 102, 3, 2022, 'fairfax', 'va');
INSERT INTO transaction VALUES (43, 4, 203, 1, 2022, 'potomac', 'md');
...
SELECT t1.transaction_id, p1.name, t1.city, t1.state
FROM person p1, transaction t1
JOIN (   SELECT max(t.transaction_id) as max_id, person_id, city, state
 FROM transaction t
 WHERE  t.t_year = 2022 AND t.transaction_type IN (1, 2)
 GROUP BY t.person_id, t.city, t.state) AS tmp
